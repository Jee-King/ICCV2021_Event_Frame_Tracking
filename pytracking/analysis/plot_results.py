...
def get_auc_curve_1(ave_success_rate_plot_overlap, valid_sequence):
    ave_success_rate_plot_overlap = ave_success_rate_plot_overlap[valid_sequence, :, :]
...
def get_auc_curve_per(ave_success_rate_plot_overlap, valid_sequence):
    ave_success_rate_plot_overlap = ave_success_rate_plot_overlap[valid_sequence, :, :]
    auc_curve = ave_success_rate_plot_overlap.mean(-1) * 100.0
    # auc = auc_curve.mean(-1)
    return auc_curve
...
def print_per_sequence_results(trackers, dataset, report_name, merge_results=False,
    ...
    threshold_set_overlap = torch.tensor(eval_data['threshold_set_overlap'])
    ave_success_rate_plot_overlap = torch.tensor(eval_data['ave_success_rate_plot_overlap'])
    auc_curve = get_auc_curve_per(ave_success_rate_plot_overlap, valid_sequence)
    scores = auc_curve
    ...
    scores_per_tracker = {k: scores[:, i] for i, k in enumerate(tracker_disp_names)}
