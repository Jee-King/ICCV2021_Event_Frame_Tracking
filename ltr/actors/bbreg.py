...
class AtomActor(BaseActor):
    ...
    def __call__(self, data):
        ...
        iou_pred = self.net(data['train_images'], data['test_images'], data['train_event_stack'], data['test_event_stack'], data['train_anno'], data['test_proposals'])
        # for name, parms in self.net.named_parameters():
        #     print('-->name:', name, '-->grad_requirs:', parms.requires_grad)
        #     print(self.net.optimizer.state_dict()['param_groups'][0]['lr'])
